...
namespace UberLogger {
    ...
    public class LogInfo {
        ...
        /// 来自Unity的调用堆栈
        /// </summary>
        public string Callstack_String;
        ...
        public LogInfo(UnityEngine.Object source, string channel, LogSeverity severity, string callstack_fromunity, object message, params object[] par) {
            Source = source;
            Channel = channel;
            Severity = severity;
            Message = "";
            ...
            Callstack_String = callstack_fromunity;
            TimeStamp = Logger.GetTime();
            TimeStampAsString = String.Format("{0:0.0000}", TimeStamp);
        }
    }
                ...
                if (!AlreadyLogging) {
                    try {
                        ...
                        if (logType == LogType.Error || logType == LogType.Exception) {
                            ...
                            logInfo = new LogInfo(null, "", severity, unityCallStack, unityMessage);
                        }
                        else {
                            logInfo = new LogInfo(null, "", severity, "", unityMessage);
